...
#pragma warning restore 618
    public class NetworkManagerUIController : MonoBehaviour
    {
        ...
        public ArPingPongController ArPingPongController;
        ...
        public Button BallMakeButton;//追加

        public Button RetryButton;//追加

        public GameObject ScorePanel;

        public Toggle PlayModeToggle;//追加
...
#pragma warning restore 618            
            ...
            _ChangeButtonUIVisibility(false);
        }
...
#pragma warning restore 618
        {
            ...
            ArPingPongController.OnEnterResolvingModeClick();
        }
...
#pragma warning restore 618
        {
            ...
            if (m_Manager.matches != null)
            {
                ...
                foreach (var match in m_Manager.matches)
                {
                    ...
                    var text = "VS " + _GeetRoomNumberFromNetworkId(match.networkId);
                    GameObject button = m_JoinRoomButtonsPool[i++];
                    button.GetComponentInChildren<Text>().text = text;
                    button.GetComponentInChildren<Button>().GetComponentInChildren<Text>().text = match.currentSize < 2 ? "JOIN AS CHALLENGER" : "JOIN AS SPECTATOR";
...
#pragma warning restore 618
        {
            ...
            SnackbarText.text = IsPlayer()?"Find a plane, tap to create a Cloud Anchor.": "";
            
            CurrentRoomLabel.GetComponentInChildren<Text>().text = "Room: " + m_CurrentRoomNumber;

            _ChangeButtonUIVisibility(IsPlayer());
        }
...
#pragma warning restore 618
        {
            ...
            m_CurrentRoomNumber = _GeetRoomNumberFromNetworkId(matchInfo.networkId);
            _ChangeLobbyUIVisibility(false);
            SnackbarText.text = IsPlayer() ? "Waiting for Cloud Anchor to be hosted..." : "";
        ...
        private void _ChangeLobbyUIVisibility(bool visible)
        {
            ...
            PlayModeToggle.gameObject.SetActive(visible);//追加
        ...
        /// 
        /// </summary>
        private void _ChangeButtonUIVisibility(bool visible)
        {
            BallMakeButton.gameObject.SetActive(visible);
        ...
        /// 
        /// </summary>
        public void OnPlayModeToggleClicked()
        {
            isPlayer = PlayModeToggle.isOn;
