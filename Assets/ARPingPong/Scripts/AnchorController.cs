...
#pragma warning restore 618
        ...
        /// </summary>
        private ArPingPongController m_ArPingPongController;
        ...
        public void Start()
        {
            m_ArPingPongController = GameObject.FindObjectOfType<ArPingPongController>();
        }
...
#pragma warning restore 618
        ...
        public void HostLastPlacedAnchor(Component lastPlacedAnchor)
        {
            ...
            XPSession.CreateCloudAnchor(anchor).ThenAction(result =>
            {
                if (result.Response != CloudServiceResponse.Success)
                {
                    ...
                    m_ArPingPongController.OnAnchorHosted(false, result.Response.ToString());
                    return;
                }
                ...
                m_ArPingPongController.OnAnchorHosted(true, result.Response.ToString());
            });
#endif
        }
        ...
        {
            m_ArPingPongController.OnAnchorInstantiated(false);
            ...
            XPSession.ResolveCloudAnchor(cloudAnchorId).ThenAction((System.Action<CloudAnchorResult>)(result =>
            {
                if (result.Response != CloudServiceResponse.Success)
                {
                    ...
                    m_ArPingPongController.OnAnchorResolved(false, result.Response.ToString());
                    m_ShouldResolve = true;
                    return;
                }
                ...
                m_ArPingPongController.OnAnchorResolved(true, result.Response.ToString());
        ...
        {
            var cloudAnchorController = GameObject.FindObjectOfType<ArPingPongController>();
            cloudAnchorController.ResetWorldOrigin();
        ...
        private void _OnChangeId(string newId)
        {
            if (!m_IsHost && newId != string.Empty)
            {
                ...
                Debug.Log("AnchorController on changed id : " + m_CloudAnchorId);
