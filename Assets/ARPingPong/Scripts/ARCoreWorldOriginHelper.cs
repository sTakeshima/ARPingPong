...
{
    using Ricoh.TeamHaptics.AR.PingPong.ArCore;
    ...
    public class ARCoreWorldOriginHelper : MonoBehaviour
    {
        ...
        public void Update()
        {
            ...
            for (int i = 0; i < m_NewPlanes.Count; i++)
            {
                ...
                planeObject.GetComponent<ArCoreDetectedPlaneVisualizer>().Initialize(m_NewPlanes[i]);
        ...
        /// <summary>
        /// �ǉ��@���]���u���g���C�̂��߁A��U�f�o�C�X�̈ʒu�������������Ă�����K�v������
        /// </summary>
